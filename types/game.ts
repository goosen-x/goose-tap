...
// Upgrade definitions
// Note: IDs are preserved for backward compatibility with existing user data
export const UPGRADES: Upgrade[] = [
  // === Cards (permanent upgrades) ===
  {
    id: 'golden-goose',
    name: 'Tap Power',
  ...
  },
  {
    id: 'egg-farm',
    name: 'Passive Income',
    description: 'Earn coins every hour',
    icon: '🥚',
    baseCost: 2000,
    costMultiplier: 2,
    bonusType: 'hour',
